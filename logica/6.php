...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="6.php">6</a>
      </li>
      <li class="nav-item">
...
<form  method="get"> 
<fieldset>
        <legend><H3>INVERTER</H3></legend>
      
<input class="caixa" type = 'text' required name="num1" placeholder="numero de 3 digitos">
<br>
<br>
...
echo 'Invertido fica: ',strrev($num1);
