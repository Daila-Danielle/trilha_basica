...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="3.php">3</a>
      </li>
      <li class="nav-item">
...
<form method="get"> 
<fieldset>
        <legend><H3>INSIRA UM NÚMERO </H3></legend>

      
      <input class="caixa" type = 'number' required name="num" placeholder="Digite o numero">
      <br>
      <br>
...
if($num >= 1){
    echo "<br>ESSE NUMERO É POSITIVO";  
}

if($num < 0){
    echo "<br>ESSE NUMERO É NEGATIVO";  
}

if($num == 0){
    echo "<br>ESSE NUMERO É ZERO!";  
}
