...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="8.php">8</a>
      </li>
      <li class="nav-item">
...
<form  method="get"> 
<fieldset>
        <legend><H3>PAR OU IMPAR</H3></legend>
      
<input class="caixa" type = 'number' required name="num1" placeholder="digite um numero">
<br>
<br>
...
if ($num1%2==0){
    print "<br>O numero: $num1, É PAR";
}

elseif ($num1%2!=0){
    print "<br>O numero: $num1, É IMPAR";
}
