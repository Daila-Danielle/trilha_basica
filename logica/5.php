...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="5.php">5</a>
      </li>
      <li class="nav-item">
...
<form method="get"> 
<fieldset>
        <legend><H3>DIVISÃO</H3></legend>
      
<input class="caixa" type = 'number' required name="num1" placeholder="dividendo">
<br>

<input class="caixa" type = 'number' required name="num2" placeholder="divisor">
<br>
<br>
...
$resto = $num1%$num2;
$quo = $num1/$num2;
print "<br>quociente = $quo / resto = $resto"
?></p></center>
